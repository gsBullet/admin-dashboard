...
import { getAllBlockUsers } from "../../service/generalUsers";
...
const BlockUser = () => {
  ...
  const fetchAllBlockUsers = async () => {
    const response = await getAllBlockUsers({
      token: auth.token,
      limit,
      currentPage,
      searchTerm,
  ...
  return (
    <div>
      <PageMeta
        title="Block Users"
        description="This is Block users   page for ecommerce dashboard"
      />
      <PageBreadcrumb pageTitle="Block Users" />
      <ComponentCard
