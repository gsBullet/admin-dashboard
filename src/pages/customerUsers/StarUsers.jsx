...
const StarUsers = () => {
  ...
  const fetchAllStarUsers = async () => {
    const response = await getAllStarUsers({
      token: auth.token,
      limit,
      currentPage,
      searchTerm,
  ...
  return (
    <div>
      <PageMeta
        title="Star Users"
        description="This is star users   page for ecommerce dashboard"
      />
      <PageBreadcrumb pageTitle="Star Users" />
      <ComponentCard
        title="Star Users List"
